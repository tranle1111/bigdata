...
# Đọc dữ liệu
file_path = "../clean_data/station_day_cleaned.csv"
...
print(f"🎯 [XGBoost] R² Score: {r2_ score(y_test, y_pred)}")
...
plt.show()
joblib.dump(model_xgb, "../Mo_hinh_huan_luyen/xgboost_aqi_model_station_day.pkl")
